...
from ..backbones.spikformer import SSA,SPS_64
...
class InpaintGenerator(nn.Module):
    def __init__(self,model_cfg):
        ...
        for _ in range(stack_num):
            blocks.append(SNNTransformerBlock(hidden=hidden, num_head=num_head, dropout=dropout, n_vecs=n_vecs,
        ...
        self.sps = SPS_64(in_channels=1,embed_dims=256)
    ...
    def forward(self, masked_frames):
        ...
        patch_feat = self.sps(masked_frames.view(b * t, c, h, w))
...
class SNNTransformerBlock(nn.Module):
    ...
    def __init__(self, hidden=128, num_head=4, dropout=0.1, n_vecs=None, t2t_params=None):
        ...
        self.attention = SSA(dim=hidden,num_heads=num_head)
