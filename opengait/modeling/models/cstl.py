...
class CSTL(BaseModel):
    ...
    def build_network(self, model_cfg):
        ...
        self.conv2d_2 = SetBlock(
            BasicConv2d(_channels[0], _channels[1], 3, padding=1), True
        )
    ...
    def forward(self, inputs):
        ...
        part_classification, weighted_part_feature, selected_part_feature = (
            self.salient_learning(t_f, t_s, t_l)
        )

        feature = torch.cat(
            [aggregated_feature, weighted_part_feature, selected_part_feature], -1
        )
        ...
        retval = {
            ...
            "inference_feat": {"embeddings": feature},
        }
