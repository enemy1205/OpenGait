...
class OriginFormerGaitConcat(BaseModel):
    #
    def build_network(self, model_cfg):
        self.encoder = EncoderNorm()
        ...
        self.BNNecks = SeparateBNNecks(
            16, channel // 2, class_num=model_cfg["SeparateBNNecks"]["class_num"]
        )
    ...
    def forward(self, inputs):
        ...
        trans_feat = (
            trans_feat.reshape(n, s, *output_size[1:]).transpose(1, 2).contiguous()
        )
