...
class AdaptiveMixPooling(nn.Module):
    ...
    def forward(self, x):
        # 自适应平均池化
        avg_pooled = F.adaptive_avg_pool2d(x, self.output_size)  # [n, c, output_size[0], output_size[1]]
        
        # 自适应最大池化
        max_pooled = F.adaptive_max_pool2d(x, self.output_size)  # [n, c, output_size[0], output_size[1]]
