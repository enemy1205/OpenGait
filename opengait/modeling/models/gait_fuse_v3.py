...
from ..backbones.tau_module import MidMetaNet
...
class FuseGait_V3(BaseModel):
    def build_network(self, model_cfg):
        ...
        hid_T    = model_cfg['MidMetaNet']['hid_T']
        N_T    = model_cfg['MidMetaNet']['N_T']
        mlp_ratio    = model_cfg['MidMetaNet']['mlp_ratio']
        drop    = model_cfg['MidMetaNet']['drop']
        drop_path    = model_cfg['MidMetaNet']['drop_path']
        
        self.hid = MidMetaNet(30*channels[1], hid_T, N_T,
    ...
    def forward(self, inputs):
        ...
        out5 = self.hid(out4.transpose(1,2))  
        # Temporal Pooling, TP
        outs_1 = self.TP(out5, seqL, options={"dim": 2})[0]  # [n, c, h, w]
