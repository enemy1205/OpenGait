...
class SimVP_Rec(BaseModel):
    def build_network(self, model_cfg):
        ...
        self.gait_lr = model_cfg['gait_lr']
        for param in self.netGait.named_parameters():
    ...
    def finetune_parameters(self):
        ...
        return [{'params': dis_tune_params, 'lr': 0.001},{'params':gait_tune_params,'lr':self.gait_lr} ,{'params': others_params}]

    def phase_1_parameters(self):
        dis_tune_params = list()
        others_params = list()
        for name, p in self.named_parameters():
            if not p.requires_grad:
            ...
            if 'dis' in name:
                ...
                others_params.append(p)
        return [{'params': dis_tune_params, 'lr': 0.001},{'params': others_params}]
    
    def phase_2_parameters(self):
        dis_tune_params = list()
        gait_tune_params = list()
        others_params = list()
        for name, p in self.named_parameters():
            ...
            if 'dis' in name:
                ...
                others_params.append(p)
        return [{'params': dis_tune_params, 'lr': 0.0001},{'params':gait_tune_params,'lr':self.gait_lr} ,{'params': others_params}]
    ...
    def get_optimizer(self, optimizer_cfg):
        ...
        # optimizer = optimizer(self.phase_1_parameters(), **valid_arg)
        return optimizer
    ...
    def forward(self, inputs):
        ...
        if True:
            ...
            #     self.optimizer = self.phase_2_parameters
