...
blocks_map = {
    ...
    "p3d": BasicBlockP3D,
    "3d": BasicBlock3D,
    "if3d": BasicBlockIfNode3D,
}


class DeepSnnGait(BaseModel):
    ...
    def forward(self, inputs):
        functional.reset_net(self.layer2)
        functional.reset_net(self.layer3)
        functional.reset_net(self.layer4)
        ...
        # Temporal Pooling, TP
        outs = self.TP(out4, seqL, dim=2, options={"dim": 2})[0]  # [n, c, h, w]
