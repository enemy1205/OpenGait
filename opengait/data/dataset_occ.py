...
class OcclusionDataSet(tordata.Dataset):
    def __init__(self, data_cfg, training):
        ...
        # self.seqs_info = [[id,type,view,pkl_path]*8192]
                ...
                for typ in sorted(os.listdir(osp.join(dataset_root, lab))):
                    for vie in sorted(os.listdir(osp.join(dataset_root, lab, typ))):
                        ...
                        if seq_dirs != []:
                            ...
                            seq_dirs.append(
                                seq_dirs[0].replace(
                                    "GaitDatasetB-silh_pkl", "GaitDatasetB-silh_occ_pkl"
                                )
                            )
